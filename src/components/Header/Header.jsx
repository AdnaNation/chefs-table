...
const Header = () => {
  ...
  <div className="hero-content text-center text-neutral-content">
    <div className="max-w-4xl text-white">
      ...
      <p className="mb-5 text-xs lg:text-2xl">Join our thriving community of food enthusiasts, share your culinary creations, and connect with fellow cooks from around the world. With regular updates and fresh content, there is always something new to explore and savor on our cooking recipe blog site. Let the culinary adventure begin!</p>
