const Footer = () => {
  return (
    <footer className="footer footer-center p-5 lg:p-10 bg-black rounded text-gray-300 mt-3">
      ...
      <hr className="border border-red-100 w-[100%]" />
      <aside>
        <p>Copyright © 2017, All Rights Reserved by ADNAN.</p>
      </aside>
    </footer>
  );
};
